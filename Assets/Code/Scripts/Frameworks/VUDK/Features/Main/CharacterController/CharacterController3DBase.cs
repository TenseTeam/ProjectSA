namespace VUDK.Features.Main.CharacterController
{
    ...
    public abstract class CharacterController3DBase : CharacterControllerBase
    {
        ...
        public override bool IsMoving => Rigidbody.velocity.magnitude > 0.1f && IsGrounded;
        ...
        public override bool MoveCharacter(Vector2 direction)
        {
            ...
            if (!IsSliding)
            {
                ...
                {
                    Vector3 velocity = new Vector3(movementDirection.x * CurrentSpeed, Rigidbody.velocity.y, movementDirection.z * CurrentSpeed);
